let experiencias = [
    {
        ...
        "descricao":"Desenvolvi automações que acessavam planilhas, sites, programas de terceiros e fazia o dashboards dessass automações para acompanhamento do desenpenho da automação, ensinei colegas iniciantes como utilizar algumas ferramentas da empresa e auxiliei no desenvolvimento de varias automações."
    },
    {
        "empresa": "Yellow Lamp",
        "cargo": "Desenvolvedor back-end",
        "periodo": "(08/2019 - 03/2020)",
        "descricao":"Participei de alguns projetos já em andamento, tais como, sistema de delivery, sistema de loja virtual e sistemas mais avançados utilizando API de terceiros. Participei do desenvolvimento de um projeto grande de pesquisa e avaliação de restaurantes onde fiquei responsavel integralmente pelo back-end desenvolvido em PHP utilizando o framework Laravel. E desenvolvi uma página web com painel administrativo para inserção de conteúdo dinâmico."
    },
    {
        "empresa": "SVMA",
